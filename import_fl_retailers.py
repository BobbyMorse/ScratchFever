    ...
    async with pool.acquire() as conn:
        for row in rows:
            ...
            result = await conn.execute("""
                INSERT INTO fl_retailers (id, name, address, city, state, zip_code, phone, latitude, longitude, geo_approximated, is_active, last_seen_at)
                VALUES ($1,$2,$3,$4,'FL',$5,$6,$7,$8,$9,TRUE,NOW())
